...
11. **Verificación de citas cruzadas entre pasos.** La EXISTENCIA del paso citado ya la verifica el código de forma determinística (ver coherenciaRmd.ts), y esas alertas se agregan aparte: **NO reportes alertas de tipo "referencia_cruzada_rota" por un paso citado que no existe.** Lo que sí te toca: si una cita apunta a un paso que SÍ existe pero cuyo CONTENIDO ya no corresponde a lo que la cita da a entender (ej. el paso 4.3.2 cita "la balanza preparada en 4.2.3" y el 4.2.3 ya no habla de preparar una balanza), eso requiere criterio y es tuyo — repórtalo como "referencia_cruzada_rota" explicando la incoherencia de contenido.

12. **Cuadre de cantidades de insumos.** Ya lo hace el código: suma las cantidades numéricas que el procedimiento indica para cada insumo y las compara contra el total de la tabla de INSUMOS. **NO reportes alertas de tipo "cantidad_insumo_no_cuadra"** — sumar doce cantidades sin equivocarse es justamente lo que conviene dejarle a la aritmética.

13. **Todo equipo/instrumento/material listado debe estar preparado en el procedimiento.** Ya lo verifica el código cruzando cada ítem de la sección 1 contra el texto de todos los pasos. **NO reportes alertas de tipo "equipo_sin_preparacion_registrada".**

14. **Nota de verificación presencial cuando el paso exige Visto Bueno (VB).** Ya lo verifica el código sobre el campo "requiereVB" y el texto del paso. **NO reportes alertas de tipo "nota_vb_faltante".**

15. **Fallas de redacción en el RMD vigente.** Además de las discrepancias contra el Control de Cambio, señalá errores de redacción genuinos que encuentres en el texto del procedimiento y del resto de las secciones: errores gramaticales, palabras mal escritas, frases incoherentes o ambiguas que dificulten entender la instrucción, palabras faltantes o repetidas, y puntuación que cambie el sentido de la instrucción. Dos casos de esta misma regla ya los detecta el código y NO tenés que reportarlos: las palabras repetidas dos veces seguidas y los paréntesis sin cerrar. Concentrate en lo que sí necesita criterio: gramática, frases ambiguas, palabras faltantes y puntuación que cambia el sentido. **EXCEPTUÁ explícitamente dos cosas — NUNCA las reportes:** (a) el uso de mayúsculas, porque el RMD se redacta convencionalmente todo en mayúsculas por norma, no es un error; (b) las tildes/acentos faltantes o mal puestos, porque estos documentos los omiten de forma habitual y no es objeto de esta verificación. Repórtalas como alertaCoherencia de tipo "falla_redaccion", severidad "baja" si es un error menor que no afecta la comprensión o "media" si genera ambigüedad real sobre qué hacer, con "pasosAfectados" incluyendo el pasoId (vacío si aplica a una sección general) y "descripcion" citando el fragmento exacto con el error y explicando en qué consiste la falla.
...
12. **Verificación de citas cruzadas entre pasos.** La EXISTENCIA del paso citado ya la verifica el código de forma determinística (ver coherenciaRmd.ts), y esas alertas se agregan aparte: **NO reportes alertas de tipo "referencia_cruzada_rota" por un paso citado que no existe.** Lo que sí te toca: si una cita apunta a un paso que SÍ existe pero cuyo CONTENIDO ya no corresponde a lo que la cita da a entender (ej. el paso 4.3.2 cita "la balanza preparada en 4.2.3" y el 4.2.3 ya no habla de preparar una balanza), eso requiere criterio y es tuyo — repórtalo como "referencia_cruzada_rota" explicando la incoherencia de contenido.

13. **Cuadre de cantidades de insumos.** Ya lo hace el código: suma las cantidades numéricas que el procedimiento indica para cada insumo y las compara contra el total de la tabla de INSUMOS. **NO reportes alertas de tipo "cantidad_insumo_no_cuadra"** — sumar doce cantidades sin equivocarse es justamente lo que conviene dejarle a la aritmética.

14. **Todo equipo/instrumento/material listado debe estar preparado en el procedimiento.** Ya lo verifica el código cruzando cada ítem de la sección 1 contra el texto de todos los pasos. **NO reportes alertas de tipo "equipo_sin_preparacion_registrada".**

15. **Nota de verificación presencial cuando el paso exige Visto Bueno (VB).** Ya lo verifica el código sobre el campo "requiereVB" y el texto del paso. **NO reportes alertas de tipo "nota_vb_faltante".**

16. **Fallas de redacción.** En AMBOS documentos, señalá errores de redacción genuinos: errores gramaticales, palabras mal escritas, frases incoherentes o ambiguas que dificulten entender la instrucción, palabras faltantes o repetidas, y puntuación que cambie el sentido. Dos casos de esta misma regla ya los detecta el código y NO tenés que reportarlos: las palabras repetidas dos veces seguidas y los paréntesis sin cerrar. Concentrate en lo que sí necesita criterio: gramática, frases ambiguas, palabras faltantes y puntuación que cambia el sentido. **EXCEPTUÁ explícitamente dos cosas — NUNCA las reportes:** (a) el uso de mayúsculas (el RMD se redacta convencionalmente todo en mayúsculas, no es un error); (b) las tildes/acentos faltantes o mal puestos (estos documentos los omiten de forma habitual, no es objeto de esta verificación). Repórtalas como alertaCoherencia de tipo "falla_redaccion", severidad "baja" o "media" según afecten o no la comprensión, indicando en "descripcion" en cuál documento (vigente o borrador) está el error y citando el fragmento exacto.
